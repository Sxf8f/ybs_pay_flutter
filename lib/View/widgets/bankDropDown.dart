...
class bankDropDown extends StatelessWidget {
  ...
  const bankDropDown({super.key, required this.selectedBank, required this.banks, required this.onChanged});
            ...
            Column(
              ...
              children: [
                Padding(
                  ...
                  child: Text("Bank",style: TextStyle(fontWeight: FontWeight.w400,
                      ...
                      children: [
                        Expanded(
                          child: DropdownButton<String>(
                            ...
                            items: banks.map<DropdownMenuItem<String>>((qualifications) {
