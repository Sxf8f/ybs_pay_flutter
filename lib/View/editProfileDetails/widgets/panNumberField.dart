...
/// Constructor for the pan number field with title above the text field.
class panNumberField extends StatelessWidget {
  final TextEditingController panNumberController;
  const panNumberField({super.key, required this.panNumberController});
            ...
            Column(
              ...
              children: [
                Padding(
                  ...
                  child: Text("Pan Number",style: TextStyle(fontWeight: FontWeight.w400,
