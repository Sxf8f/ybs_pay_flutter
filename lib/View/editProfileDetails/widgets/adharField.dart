...
/// Constructor for the adhar number field with title.

class adharField extends StatelessWidget {
  final TextEditingController adharNumberController;
  const adharField({super.key, required this.adharNumberController});
            ...
            Column(
              ...
              children: [
                Padding(
                  ...
                  child: Text("Aadhaar Number",style: TextStyle(fontWeight: FontWeight.w400,
