...
/// Constructor for the gst field with title above the text field.
class gstField extends StatelessWidget {
  final TextEditingController gstController;
  const gstField({super.key, required this.gstController});
            ...
            Column(
              ...
              children: [
                Padding(
                  ...
                  child: Text("GSTIN",style: TextStyle(fontWeight: FontWeight.w400,
