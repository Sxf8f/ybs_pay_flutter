...
/// Constructor for the pin code field with title above the text field.

class pinCodeField extends StatelessWidget {
  final TextEditingController pinCodeController;
  const pinCodeField({super.key, required this.pinCodeController});
            ...
            Column(
              ...
              children: [
                Padding(
                  ...
                  child: Text("Pin Code",style: TextStyle(fontWeight: FontWeight.w400,
