...
/// Constructor for the outlet name field with title above the text field.
class outletNameField extends StatelessWidget {
  final TextEditingController outletNameController;
  const outletNameField({super.key,required this.outletNameController});
            ...
            Column(
              ...
              children: [
                Padding(
                  ...
                  child: Text("Outlet Name",style: TextStyle(fontWeight: FontWeight.w400,
