...
class customerCareBox extends StatefulWidget {
  const customerCareBox({super.key});
                      ...
                      Row(
                        children: [
                          SizedBox(
                              height: 30,
                              width: 30,
                              child: SvgPicture.asset('assets/svg/customerService.svg')),
                          Padding(
                            padding: EdgeInsets.only(left: scrWidth*0.07),
                            child: Text('Customer Care',style: TextStyle(
                                fontWeight: FontWeight.w500,fontSize: scrWidth*0.033),),
                          ),
                        ],
                      ),
                      Icon(customerCareDrop?Icons.keyboard_arrow_up_rounded:Icons.keyboard_arrow_down_rounded)
